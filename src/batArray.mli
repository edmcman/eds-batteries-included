...
val print : ?first:string -> ?last:string -> ?sep:string -> (('cap, 'a) BatIO.outputWrite -> 'b -> unit) -> ('cap, 'a) BatIO.outputWrite -> 'b t -> unit
...
(** {6 Boilerplate code}*)
  ...
  val print : ?first:string -> ?last:string -> ?sep:string -> (('cap, 'a) BatIO.outputWrite -> 'b -> unit) ->  ('cap, 'a) BatIO.outputWrite -> ('b, [>`Read]) t -> unit
